(function ($) {
    ...
    var ajaxurl = revista_admin.ajax_url;
    var topStoriesNonce = revista_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#revista-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: revista_admin.upload_image,
            button: {
            text: revista_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'revista_notice_dismiss',
            '_wpnonce': topStoriesNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-revista-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-revista-notice').addClass('twp-installing');

        var data = {
            'action': 'revista_install_plugins',
            '_wpnonce': topStoriesNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = revista_admin.active
            var deactivate = revista_admin.deactivate
