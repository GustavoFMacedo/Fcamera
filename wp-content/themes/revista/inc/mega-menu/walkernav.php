...
class Revista_Walkernav extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if (isset($args->has_children) && !$args->has_children && (($child_cats && $hasMegaMenu_subcat) || ($hasMegaMenu && $mm_posts_query) && $depth == 0)) {
            ...
            $item_output .= '<span class="icon">' . revista_theme_svg('chevron-down', true) . '</span>';
        }
        ...
        $item_output .= (($depth == 0 || 1) && $has_children) ? '<span class="icon">' . revista_theme_svg('chevron-down', true) . '</span></a>' : '</a>';
    ...
    public function end_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if ($object_id && isset($item->object) && $item->object == 'category' && $depth == 0 && ($hasMegaMenu || $hasMegaMenu_subcat)) {
            ...
            if (($child_cats && $hasMegaMenu_subcat) || ($hasMegaMenu && $mm_posts_query)) {
                ...
                $output .= '<div class="wrapper-inner wrapper-inner-collapse">';
                ...
                if ($hasMegaMenu_subcat && $child_cats) {
                    ...
                    foreach ($child_cats as $child_cat) {
                        ...
                        $output .= '<span class="icon">' . revista_theme_svg('chevron-right', true) . '</span>';
                        $output .= '</a>';
                        $output .= '</div>';
                    }
                    $output .= '</div>';
